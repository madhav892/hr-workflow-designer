...
// Check if workflow has cycles (DFS-based)
...
// Get all connected nodes from start using BFS
...
function validateNodeData(node: WorkflowNode): ValidationError[] {
  ...
  // Title validation for all nodes
...
export function validateWorkflow(
  ...
  // Check for start node with incoming connections
  ...
  // Check for end nodes with outgoing connections
